...
class Message extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('user_group, user_type, user_status, created_by, modified_by, send_by', 'numerical', 'integerOnly' => true),
            array('subject', 'length', 'max' => 250),
            array('modified_on, send_on', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, user_group, user_type, user_status, subject, message_body, created_by, created_on, modified_by, modified_on, send_by, send_on', 'safe', 'on' => 'search'),
        );
    }
