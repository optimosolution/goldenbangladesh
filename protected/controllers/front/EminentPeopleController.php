...
class EminentPeopleController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('delete', 'create', 'update', 'picture', 'dynamicthana'),
                'users' => array('@'),
            ),
    ...
    public function actionPicture() {
        $model = new EminentPicture;

        // Uncomment the following line if AJAX validation is needed
        // $this->performAjaxValidation($model);

        if (isset($_POST['EminentPicture'])) {
            $model->attributes = $_POST['EminentPicture'];
            if ($model->save()) {
                $this->redirect(array('view', 'id' => $model->id));
            }
        }
    ...
    public function actionAdmin() {
        $model = new EminentPeople('search_index');
