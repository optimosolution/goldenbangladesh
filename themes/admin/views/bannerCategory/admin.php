...
$this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'filter' => CHtml::activeDropDownList($model, 'parent_id', CHtml::listData(BannerCategory::model()->findAll(array('condition' => 'parent_id=0', "order" => "title")), 'id', 'title'), array('empty' => 'All')),
