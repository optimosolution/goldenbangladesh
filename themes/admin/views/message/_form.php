...
<div class="form">
    ...
    <div class="row-fluid">
        ...
        <div class="span2">
            <?php echo $form->dropDownListControlGroup($model, 'user_type', CHtml::listData(UserType::model()->findAll(array('condition' => '', "order" => "title")), 'id', 'title'), array('empty' => '--please select--', 'class' => 'span12')); ?>
        </div>
        <div class="span2">
