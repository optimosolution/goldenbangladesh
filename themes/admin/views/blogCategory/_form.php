...
<?php echo $form->dropDownListControlGroup($model, 'parent_id', CHtml::listData(BlogCategory::model()->findAll(array('condition' => 'parent_id=0 AND published=1', "order" => "title")), 'id', 'title'), array('empty' => '--please select--', 'class' => 'span5')); ?>
