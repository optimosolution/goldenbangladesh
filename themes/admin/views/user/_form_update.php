...
<div class="widget-box">
    ...
    <div class="widget-content tab-content">
        ...
        <div id="tab2" class="tab-pane">          
            ...
            ?>
            <?php echo $form->fileFieldControlGroup($model_profile, 'profile_picture', array('maxlength' => 255, 'class' => 'span5')); ?>
            <?php echo $form->dropDownListControlGroup($model_profile, 'user_type', CHtml::listData(UserType::model()->findAll(array('condition' => '', "order" => "title")), 'id', 'title'), array('empty' => '--please select--', 'class' => 'span5', 'options' => array())); ?>
        </div>
    </div>
</div>
